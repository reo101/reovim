...
{1 :iguanacucumber/magazine.nvim
 ...
 :dependencies [:nvim-treesitter/nvim-treesitter
                ...
                { 1 "iguanacucumber/mag-nvim-lsp" :name :cmp-nvim-lsp :opts {}}
                :saadparwaiz1/cmp_luasnip
                ;; :hrsh7th/cmp-buffer
                { 1 "iguanacucumber/mag-buffer" :name :cmp-buffer}
                ;; :hrsh7th/cmp-nvim-lua
                { 1 "iguanacucumber/mag-nvim-lua" :name :cmp-nvim-lua}
                ;; :hrsh7th/cmp-path
                ...
                ;; :hrsh7th/cmp-cmdline
                { 1 "iguanacucumber/mag-cmdline" :name :cmp-cmdline}
                :hrsh7th/cmp-omni
