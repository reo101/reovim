...
local vi_mode_provider = function()
    ...
    return " " .. mode_alias[vim.fn.mode()] .. " î‚¾"
end

local percentage_provider = function()
    local cursor = require("feline.providers.cursor")
    return "î‚¼ " .. cursor.line_percentage() .. " "
end
    ...
    components = {
        left = {
            active = {
                ...
                { provider = "git_branch" , icon = "î‚  ", right_sep = "  ",
                    enabled = function() return vim.b.gitsigns_status_dict ~= nil end },
                { provider = "file_info" },
                { provider = "î‚¼" , hl = { fg = "bg", bg = "black" }},
            },
            inactive = {
                { provider = vi_mode_provider, hl = vi_mode_hl, right_sep = " " },
                { provider = "git_branch" , icon = "î‚  ", right_sep = "  ",
